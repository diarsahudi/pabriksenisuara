export default function App() {
  return (
    ...
    >
      ...
      >
        <div style={{ fontWeight: "bold" }}>Pabrik Seni Suara</div>
      ...
      >
        ...
        <h1 style={{ fontSize: 56, fontWeight: 900, margin: 0 }}>
          Pabrik Seni Suara
        </h1>
        ...
        >
          Creative music ecosystem untuk produksi, rekaman, dan kolaborasi
          karya.
        </p>
      ...
      >
        <h2 style={{ fontSize: 40 }}>Ecosystem</h2>
        <p style={{ opacity: 0.6 }}>
      ...
      >
        <h2 style={{ fontSize: 40 }}>Contact</h2>
